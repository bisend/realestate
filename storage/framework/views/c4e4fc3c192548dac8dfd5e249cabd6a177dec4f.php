...
<div class="wrapper">
    <div class="container-fluid header-container" <?php if($static_data['design_settings']['slider_background']): ?> style="background-image: url('<?php echo e(URL::asset('/assets/images/home/').'/'.$static_data['design_settings']['slider_background']); ?>')" <?php endif; ?>>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-lg-6">
                        <ul class="top-menu">
                            ...
                            <li><a href="<?php echo e(route('message')); ?>"><i class="fa fa-envelope"></i> <?php echo e($static_data['strings']['messages']); ?></a></li><?php endif; ?>
        ...
        <div class="container" id="slider">
            <div class="row">
                <div class="col-sm-12">
                    <h1 class="slider-heading"><?php echo e($static_data['strings']['opt_slider_heading']); ?></h1>
