...
<div class="col s12 mtop10">
    {!! Form::open(['method' => 'put', 'url' => route('owner_my_account_update', Auth::user()->id), 'files' => 'true']) !!}
    ...
    <div class="col l4 m4 s6">
        <div class="form-group  {{$errors->has('first_name') ? 'has-error' : ''}}">
            {!! Form::text('first_name', $user->owner->first_name, ['id' => 'first_name', 'class' => 'form-control', 'placeholder' => get_string('first_name')]) !!}
    ...
    <div class="col l4 m4 s6">
        <div class="form-group {{$errors->has('last_name') ? 'has-error' : ''}}">
            {!! Form::text('last_name', $user->owner->last_name, ['id' => 'last_name', 'class' => 'form-control', 'placeholder' => get_string('last_name')]) !!}
    ...
    <div class="col l4 m4 s6">
        <div class="form-group {{$errors->has('last_name') ? 'has-error' : ''}}">
            {!! Form::text('company', $user->owner->company, ['id' => 'company', 'class' => 'form-control', 'placeholder' => get_string('company')]) !!}
    ...
    <div class="col l4 m4 s6">
        <div class="form-group {{$errors->has('phone') ? 'has-error' : ''}}">
            {!! Form::text('phone', $user->owner->company, ['id' => 'phone', 'class' => 'form-control', 'placeholder' => get_string('phone')]) !!}
    ...
    <div class="col l4 m4 s6">
        <div class="form-group {{$errors->has('address') ? 'has-error' : ''}}">
            {!! Form::text('address', $user->owner->address, ['id' => 'address', 'class' => 'form-control', 'placeholder' => get_string('address')]) !!}
    ...
    <div class="col l4 m4 s6">
        <div class="form-group {{$errors->has('city') ? 'has-error' : ''}}">
            {!! Form::text('city', $user->owner->city, ['id' => 'city', 'class' => 'form-control', 'placeholder' => get_string('city')]) !!}
    ...
    <div class="col l4 m4 s6">
        <div class="form-group {{$errors->has('state') ? 'has-error' : ''}}">
            {!! Form::text('state', $user->owner->state, ['id' => 'state', 'class' => 'form-control', 'placeholder' => get_string('state')]) !!}
    ...
    <div class="col l4 m4 s6">
        <div class="form-group {{$errors->has('country') ? 'has-error' : ''}}"">
            {!! Form::text('country', $user->owner->country, ['id' => 'country', 'class' => 'form-control', 'placeholder' => get_string('country')]) !!}
    ...
    <div class="col l4 m4 s6">
        <div class="form-group {{$errors->has('zip') ? 'has-error' : ''}}">
            {!! Form::text('zip', $user->owner->zip, ['id' => 'zip', 'class' => 'form-control', 'placeholder' => get_string('zip')]) !!}
