...
@section('title')
    <title>{{get_string('edit_service') . ' - ' . get_setting('site_name', 'site')}}</title>
@endsection

@section('content')
@section('page_title')
    <h3 class="page-title mbot10">{{get_string('edit_service')}}</h3>
@endsection
<div class="col s12">
    @if(!$errors->isEmpty())
        <span class="wrong-error">* {{get_string('validation_error')}}</span>
    @endif
    {!!Form::open(['method' => 'patch', 'url' => route('owner.service.update', $service->id), 'files' => 'true'])!!}
    <div class="panel">
        ...
        <div class="panel-body">
            <div class="tab-content">
                                    ...
                                    <div id="lang{{$language->id}}" class="tab-pane {{$language->default ? 'active' : ''}}">
                                        <div class="col s12">
                                            <div class="form-group  {{$errors->has('name.'.$language->id.'') ? 'has-error' : ''}}">
                                                {{Form::text('name['.$language->id.']',  $service->content($language->id)->name, ['class' => 'form-control', 'placeholder' => get_string('category_name')])}}
                                        ...
                                        <div class="col s12">
                                            {{Form::textarea('description['.$language->id.']', $service->content($language->id)->description, ['class' => 'hidden desc-content'])}}
                ...
                <div id="data-panel" class="tab-pane">
                    <div class="col s12">
                         <div class="form-group  {{$errors->has('alias') ? 'has-error' : ''}}">
                            {{Form::text('alias', $service->alias, ['class' => 'form-control', 'placeholder' => get_string('alias')])}}
                    ...
                    <div class="col m4 s6">
                        <div class="form-group  {{$errors->has('category_id') ? 'has-error' : ''}}">
                            {{Form::select('category_id', $categories, $service->category_id, ['class' => 'category-select form-control', 'placeholder' => get_string('choose_category')])}}
                    ...
                    <div class="col m4 s6">
                        <div class="form-group  {{$errors->has('location_id') ? 'has-error' : ''}}">
                            {{Form::select('location_id', $locations, $service->location_id, ['class' => 'location-select form-control', 'placeholder' => get_string('choose_location')])}}
                        ...
                        @foreach($features as $feature)
                            <div class="col s2">
                                <div class="form-group">
                                    <input type="checkbox" name="features[]" @if((old('features') && in_array_r($feature->id, old('features'))) || ($service->features && in_array($feature->id, $service->features))) checked @endif value="{{$feature->id}}" class="filled-in primary-color" id="{{$feature->id}}" />
                    ...
                    <!-- <div class="col s12">
                        <div class="form-group  {{$errors->has('video') ? 'has-error' : ''}}">
                            {{Form::text('video', $service->video, ['class' => 'form-control', 'placeholder' => get_string('video_id')])}}
                                ...
                                <div class="row mbot0">
                                    <div class="col l12 m12 s12">
                                        <div class="form-group  {{$errors->has('location.address') ? 'has-error' : ''}}">
                                            {{Form::text('location[address]', $service->location['address'], ['class' => 'form-control', 'placeholder' => get_string('address')])}}
                                    ...
                                    <div class="col l12 m12 s12">
                                        <div class="form-group  {{$errors->has('location.city') ? 'has-error' : ''}}">
                                            {{Form::text('location[city]', $service->location['city'], ['class' => 'form-control', 'placeholder' => get_string('city')])}}
                                    ...
                                    <div class="col l12 m12 s12">
                                        <div class="form-group  {{$errors->has('location.state') ? 'has-error' : ''}}">
                                            {{Form::text('location[state]', $service->location['state'], ['class' => 'form-control', 'placeholder' => get_string('state')])}}
                                    ...
                                    <div class="col l12 m12 s12">
                                        <div class="form-group  {{$errors->has('location.country') ? 'has-error' : ''}}">
                                            {{Form::text('location[country]', $service->location['country'], ['class' => 'form-control', 'placeholder' => get_string('country')])}}
                                    ...
                                    <div class="col l12 m12 s12">
                                        <div class="form-group">
                                            {{Form::text('location[geo_lon]', $service->location['geo_lon'], ['class' => 'form-control', 'placeholder' => get_string('geo_lon'), 'readonly'])}}
                                            {{Form::label('location[geo_lon]', get_string('geo_lon'))}}
                                        </div>
                                    </div>
                                    <div class="col l12 m12 s12">
                                        <div class="form-group">
                                            {{Form::text('location[geo_lat]', $service->location['geo_lat'], ['class' => 'form-control', 'placeholder' => get_string('geo_lat'), 'readonly'])}}
                                ...
                                <div class="collapsible-body">
                                    <div class="col l4 m6 s12">
                                        <div class="form-group  {{$errors->has('business_hours.week') ? 'has-error' : ''}}">
                                            {{Form::text('business_hours[week]', $service->business_hours['week'], ['class' => 'form-control', 'placeholder' => get_string('business_hours_week')])}}
                                    ...
                                    <div class="col l4 m6 s12">
                                        <div class="form-group  {{$errors->has('business_hours.sat') ? 'has-error' : ''}}">
                                            {{Form::text('business_hours[sat]', $service->business_hours['sat'], ['class' => 'form-control', 'placeholder' => get_string('business_hours_sat')])}}
                                    ...
                                    <div class="col l4 m6 s12">
                                        <div class="form-group  {{$errors->has('business_hours.sun') ? 'has-error' : ''}}">
                                            {{Form::text('business_hours[sun]', $service->business_hours['sun'], ['class' => 'form-control', 'placeholder' => get_string('business_hours_sun')])}}
                                ...
                                <div class="collapsible-body">
                                    <div class="col l4 m6 s12">
                                        <div class="form-group  {{$errors->has('contact.tel1') ? 'has-error' : ''}}">
                                            {{Form::text('contact[tel1]', $service->contact['tel1'], ['class' => 'form-control', 'placeholder' => get_string('contact_tel1')])}}
                                    ...
                                    <div class="col l4 m6 s12">
                                        <div class="form-group  {{$errors->has('contact.tel2') ? 'has-error' : ''}}">
                                            {{Form::text('contact[tel2]', $service->contact['tel2'], ['class' => 'form-control', 'placeholder' => get_string('contact_tel2')])}}
                                    ...
                                    <div class="col l4 m6 s12">
                                        <div class="form-group  {{$errors->has('contact.fax') ? 'has-error' : ''}}">
                                            {{Form::text('contact[fax]', $service->contact['fax'], ['class' => 'form-control', 'placeholder' => get_string('fax')])}}
                                    ...
                                    <div class="col l4 m6 s12">
                                        <div class="form-group  {{$errors->has('contact.email') ? 'has-error' : ''}}">
                                            {{Form::text('contact[email]', $service->contact['email'], ['class' => 'form-control', 'placeholder' => get_string('email')])}}
                                    ...
                                    <div class="col l4 m6 s12">
                                        <div class="form-group  {{$errors->has('contact.web') ? 'has-error' : ''}}">
                                            {{Form::text('contact[web]', $service->contact['web'], ['class' => 'form-control', 'placeholder' => get_string('website')])}}
                                ...
                                <div class="collapsible-body">
                                    <div class="col l4 m6 s12">
                                        <div class="form-group  {{$errors->has('social[facebook]') ? 'has-error' : ''}}">
                                            {{Form::text('social[facebook]', $service->social['facebook'], ['class' => 'form-control', 'placeholder' => get_string('facebook')])}}
                                    ...
                                    <div class="col l4 m6 s12">
                                        <div class="form-group  {{$errors->has('social[gplus]') ? 'has-error' : ''}}">
                                            {{Form::text('social[gplus]', $service->social['gplus'], ['class' => 'form-control', 'placeholder' => get_string('google_plus')])}}
                                    ...
                                    <div class="col l4 m6 s12">
                                        <div class="form-group  {{$errors->has('social[twitter]') ? 'has-error' : ''}}">
                                            {{Form::text('social[twitter]', $service->social['twitter'], ['class' => 'form-control', 'placeholder' => get_string('twitter')])}}
                                    ...
                                    <div class="col l4 m6 s12">
                                        <div class="form-group  {{$errors->has('social[instagram]') ? 'has-error' : ''}}">
                                            {{Form::text('social[instagram]', $service->social['instagram'], ['class' => 'form-control', 'placeholder' => get_string('instagram')])}}
                                    ...
                                    <div class="col l4 m6 s12">
                                        <div class="form-group  {{$errors->has('social[pinterest]') ? 'has-error' : ''}}">
                                            {{Form::text('social[pinterest]', $service->social['pinterest'], ['class' => 'form-control', 'placeholder' => get_string('pinterest')])}}
                                    ...
                                    <div class="col l4 m6 s12">
                                        <div class="form-group  {{$errors->has('social[linkedin]') ? 'has-error' : ''}}">
                                            {{Form::text('social[linkedin]', $service->social['linkedin'], ['class' => 'form-control', 'placeholder' => get_string('linkedin')])}}
                ...
                <div id="meta-panel" class="tab-pane">
                    ...
                    <div class="col l6 m6 s12">
                        <div class="form-group">
                            {{Form::text('meta_title', $service->meta_title, ['class' => 'form-control', 'placeholder' => get_string('meta_title')])}}
                            {{Form::label('meta_title', get_string('meta_title'))}}
                        </div>
                    </div>
                    <div class="col l6 m6 s12">
                        <div class="form-group">
                            {{Form::text('meta_keywords', $service->meta_keywords, ['class' => 'form-control', 'placeholder' => get_string('meta_keywords')])}}
                            {{Form::label('meta_keywords', get_string('meta_keywords'))}}
                        </div>
                    </div>
                    <div class="col s12">
                        <div class="form-group">
                            {{Form::textarea('meta_description', $service->meta_description, ['class' => 'form-control', 'placeholder' => get_string('meta_description')])}}
            ...
            <div class="col clearfix s12 mtop10">
                <div class="form-group">
                    <button class="btn waves-effect" type="submit" name="action">{{get_string('edit_service')}}</button>
                    <a href="{{route('owner.service.index')}}" class="btn waves-effect">{{get_string('service_all')}}</a>
                    <a href="#" class="delete-button btn waves-effect btn-red" data-id="{{$service->id}}"><i class="material-icons color-white">delete</i></a>
                </div>
            </div>
                    ...
                    this.on("removedfile", function(file) {
                        ...
                        if(!data){
                            ...
                            $.ajax({
                                ...
                                data: {data: data, _token: $('[name=_token]').val(), type: 'service', id: '{{$service->id}}'},
                                dataType: 'html',
        ...
        $(document).ready(function() {
            if(typeof google !== 'undefined' && google){
                var map = new google.maps.Map(document.getElementById('google-map'), {
                    center:{
                        lat: {{ $service->location['geo_lon'] }},
                        lng: {{ $service->location['geo_lat'] }}
                    },
                    zoom: 10
                });
